...
class CrudProdutos
{
    ...
    public function editar($codigo,$nome,$preco,$estoque,$categoria){
        $sql = "UPDATE tb_produtos SET nome='$nome', preco=$preco, estoque=$estoque, categoria='$categoria' WHERE id = $codigo";
        $this->conexao->exec($sql);
    }
